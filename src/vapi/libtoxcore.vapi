...
*/
	...
	public class ToxRaw {
		...
		*/
		...
		public delegate void ConnectionStatusFunc(ToxRaw tox_raw, ConnectionStatus status);
		/**
		...
		public delegate void FriendNameFunc(ToxRaw tox_raw, uint32 friend_number, uint8[] name_missing_null);
		...
		public delegate void FriendStatusMessageFunc(ToxRaw tox_raw, uint32 friend_number,  uint8[] message_missing_null);
		...
		public delegate void FriendStatusFunc(ToxRaw tox_raw, uint32 friend_number, UserStatus status);
		...
		public delegate void FriendConnectStatusFunc(ToxRaw tox_raw, uint32 friend_number, ConnectionStatus connection_status);
		...
		public delegate void FriendTypingFunc(ToxRaw tox_raw, uint32 friend_number, bool is_typing);
		...
		public delegate void ReadReceiptFunc(ToxRaw tox_raw, uint32 friend_number, uint32 message_id);
		...
		public delegate void FriendRequestFunc(ToxRaw tox_raw, [CCode (array_length = false)] uint8 public_key,  uint8[] message_missing_null);
		...
		public delegate void FriendMessageFunc(ToxRaw tox_raw, uint32 friend_number, MessageType type,  uint8[] message_missing_null);
		...
		public delegate void FileControlReceiveFunc(ToxRaw tox_raw, uint32 friend_number, uint32 file_number, FileControlStatus control);
		...
		public delegate void ChunkRequestFunc(ToxRaw tox_raw, uint32 friend_number, uint32 file_number, uint64 position, size_t length);
		...
		public delegate void FileReceiveFunc(ToxRaw tox_raw, uint32 friend_number, uint32 file_number, FileKind kind, uint64 file_size, uint8[] filename_missing_null);
		...
		public delegate void ReceiveChunkFunc(ToxRaw tox_raw, uint32 friend_number, uint32 file_number, uint64 position, uint8[] data);
